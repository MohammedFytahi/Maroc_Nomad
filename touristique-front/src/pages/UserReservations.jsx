                    ...
                    {reservations.map((reservation) => (
                        <div key={reservation?.id || Math.random()} className="bg-white rounded-lg shadow-md overflow-hidden">
                            <div className="bg-blue-600 text-white px-4 py-2">
                                <h2 className="text-xl font-semibold">{reservation?.service?.nom || "Service sans nom"}</h2>
                            </div>
                            ...
                            <div className="p-4">
                                ...
                                <div className="border-t border-gray-200 pt-3">
                                    <p className="mb-2">
                                        <span className="font-medium">Date de réservation:</span> {formatDate(reservation?.dateReservation)}
                                    </p>
